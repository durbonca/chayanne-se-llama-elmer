  ...
  return (
    <article className="mb-4 p-3 rounded-lg sm:flex sm:items-center bg-gray-200">
      <section className="text-center sm:flex-1 sm:text-left">
        ...
        <p className="text-left">Te invitamos a escuchar la respuesta en este 👉 <a className="underline text-blue-800" href={idea.url} target="_blank" rel="noreferrer">enlace</a>!</p>
      </section>
    </article>
  )
}